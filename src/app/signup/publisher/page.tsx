      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        <Card className="w-full max-w-md bg-background/80 backdrop-blur-sm border-white/20 text-foreground">
          <CardHeader className="text-center">
            <CardTitle className="text-3xl font-headline">إنشاء حساب ناشر</CardTitle>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="publisher-name" className="text-foreground/90">اسم الناشر</Label>
              <Input 
                id="publisher-name" 
                type="text" 
            ...
            <div className="space-y-2">
                <Label htmlFor="publisher-needs">ماذا تحتاج؟</Label>
                <Textarea
                    id="publisher-needs"
                    placeholder="صف ما تحتاجه من المنصة..."
                    className="bg-foreground/10 border-foreground/30 text-foreground placeholder:text-foreground/50 focus:bg-foreground/20 focus:ring-accent"
                />
            </div>
